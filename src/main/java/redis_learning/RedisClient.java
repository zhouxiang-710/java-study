...
public class RedisClient {
	...
	private static String ADDR = "r-2ze99d39962dd3e4.redis.rds.aliyuncs.com";
	...
	// 访问密码，通过redis.conf设置,无密码连接可以不用填
	...
	public void show() {
		...
		try {
			...
			SomeOperate.SetBitOperate(jedis);// 有点问题
...
//			SomeOperate.HyperLogLogOperate(jedis);// redis 2.8.9以上版本才能运行
		} catch (Exception e) {
